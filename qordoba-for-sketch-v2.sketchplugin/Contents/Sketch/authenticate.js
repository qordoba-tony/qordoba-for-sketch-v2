...
var _runtime = __webpack_require__(23);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)["clearInterval"], __webpack_require__(9)["setInterval"], __webpack_require__(0)))
...
exports['default'] = function (context) {
  ...
  webContents.on('login', function (s, username, password) {
    ...
    (0, _sketchPolyfillFetch2['default'])('https://app.qordoba.com/api/login', {
      ...
      res.json().then(function (data) {
        _api2['default'].common.setUserInfo(data);
        browserWindow.close();
      });
  ...
  if (token) {
    ...
    browserWindow.loadURL(__webpack_require__(20));
  }
};

var _sketchModuleWebView = __webpack_require__(21);

var _sketchModuleWebView2 = _interopRequireDefault(_sketchModuleWebView);

var _sketchPolyfillFetch = __webpack_require__(5);
...
var _rollbar = __webpack_require__(8);
...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/ce870f4dd98e4746ba7c6ae98b0dec40.html").path();
...
var buildBrowserAPI = __webpack_require__(22)
var buildWebAPI = __webpack_require__(24)
var fitSubviewToView = __webpack_require__(27)
var dispatchFirstClick = __webpack_require__(28)
...
var ObjCClass = __webpack_require__(1).default
var EventEmitter = __webpack_require__(4)
var parseWebArguments = __webpack_require__(25)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(6)["setTimeout"], __webpack_require__(30)["setImmediate"], __webpack_require__(0)))
...
/* globals coscript, sketch */
var timeout = __webpack_require__(6)
...
function fetchProjects() {
    ...
    var token = _sketch2['default'].Settings.settingForKey('token');
    var fetchProjectsURL = 'https://app.qordoba.com/api/organizations/3204/projects/by_type/7';
