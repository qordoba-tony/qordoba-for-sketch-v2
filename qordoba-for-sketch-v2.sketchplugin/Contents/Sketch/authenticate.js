...
if (true) {
  var sketchUtils = __webpack_require__(11)
  var sketchDebugger = __webpack_require__(13)
...
exports['default'] = function (context) {
  ...
  webContents.on('login', function (s, username, password) {
    ...
    (0, _sketchPolyfillFetch2['default'])('https://app.qordoba.com/api/login', {
      ...
      res.json().then(function (data) {
        return _api2['default'].common.setUserInfo(data);
      });
  ...
  if (_api2['default'].common.token) {
    browserWindow.loadURL(__webpack_require__(16));
  } else {
    browserWindow.loadURL(__webpack_require__(17));
  }
};

var _sketchModuleWebView = __webpack_require__(18);

var _sketchModuleWebView2 = _interopRequireDefault(_sketchModuleWebView);

var _sketchPolyfillFetch = __webpack_require__(26);
...
var _rollbar = __webpack_require__(30);
...
/* eslint-disable no-not-accumulator-reassign/no-not-accumulator-reassign, no-var, vars-on-top, prefer-template, prefer-arrow-callback, func-names, prefer-destructuring, object-shorthand */
var remoteWebview = __webpack_require__(14)
...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/c65e00797b4a529123a89f5459b7d2cc.html").path();
...
var buildBrowserAPI = __webpack_require__(19)
var buildWebAPI = __webpack_require__(21)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5)["setTimeout"], __webpack_require__(28)["setImmediate"], __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(7)["clearInterval"], __webpack_require__(7)["setInterval"], __webpack_require__(0)))
